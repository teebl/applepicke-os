...
export class Window extends React.Component {
  ...
  handleWindowMove = e => {
    ...
    if (this.mouseDown) {
      ...
      if (this.grabbing.includes('right'))
      ...
      if (this.grabbing.includes('bottom'))
        newPosition.height += deltaY
    }
    else {
      return
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div ref={grabTopRight => this.grabTopRight = grabTopRight} className='grab-top-right' />
        <div ref={grabBottomRight => this.grabBottomRight = grabBottomRight} className='grab-bottom-right' />
        <div ref={grabBottomLeft => this.grabBottomLeft = grabBottomLeft} className='grab-bottom-left' />
        <div ref={grabTopLeft => this.grabTopLeft = grabTopLeft} className='grab-top-left' />
